...
/**
 * FalseConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por false en la línea 114.
 */
public class StackArMutated1506 extends org.autotest.Stack {
    ...
    public StackArMutated1506() {
        this(org.autotest.mutants.StackArMutated1506.DEFAULT_CAPACITY);
    }

    public StackArMutated1506(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean repOK() {
        try {
            ...
            if (this.elems != null) {
                if ((this.readIndex >= (-1)) && (this.readIndex < this.elems.length)) {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        int h = java.util.Arrays.hashCode(elems);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated1506 other = ((org.autotest.mutants.StackArMutated1506) (obj));
        if (false) {
            return false;
        }
