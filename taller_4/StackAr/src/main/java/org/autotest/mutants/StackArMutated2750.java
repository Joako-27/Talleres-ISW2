...
/**
 * FalseConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por false en la línea 103.
 */
public class StackArMutated2750 extends org.autotest.Stack {
    ...
    public StackArMutated2750() {
        this(org.autotest.mutants.StackArMutated2750.DEFAULT_CAPACITY);
    }

    public StackArMutated2750(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated2750 other = ((org.autotest.mutants.StackArMutated2750) (obj));
        if (false) {
            return false;
        }
