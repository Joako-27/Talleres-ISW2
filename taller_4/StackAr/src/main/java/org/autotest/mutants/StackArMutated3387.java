...
/**
 * TrueConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por true en la línea 114.
 */
public class StackArMutated3387 extends org.autotest.Stack {
    ...
    public StackArMutated3387() {
        this(org.autotest.mutants.StackArMutated3387.DEFAULT_CAPACITY);
    }

    public StackArMutated3387(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3387 other = ((org.autotest.mutants.StackArMutated3387) (obj));
        if (true) {
            return false;
        }
