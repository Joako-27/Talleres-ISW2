...
/**
 * FalseConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por false en la línea 113.
 */
public class StackArMutated3919 extends org.autotest.Stack {
    ...
    public StackArMutated3919() {
        this(org.autotest.mutants.StackArMutated3919.DEFAULT_CAPACITY);
    }

    public StackArMutated3919(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3919 other = ((org.autotest.mutants.StackArMutated3919) (obj));
        if (false) {
            return false;
        }
