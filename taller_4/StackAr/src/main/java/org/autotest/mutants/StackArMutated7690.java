...
/**
 * TrueConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por true en la línea 113.
 */
public class StackArMutated7690 extends org.autotest.Stack {
    ...
    public StackArMutated7690() {
        this(org.autotest.mutants.StackArMutated7690.DEFAULT_CAPACITY);
    }

    public StackArMutated7690(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated7690 other = ((org.autotest.mutants.StackArMutated7690) (obj));
        if (true) {
            return false;
        }
